	...
	class iceEditor {
		constructor(id) {
			...
			this.face = [{
				...
				type: 'img',
				list: [
					{title:'嘻嘻',content:'/static/assets/images/tootha_thumb.gif'},
					{title:'哈哈',content:'/static/assets/images/laugh.gif'},
					{title:'可爱',content:'/static/assets/images/tza_thumb.gif'},
					{title:'可怜',content:'/static/assets/images/kl_thumb.gif'},
					{title:'挖鼻屎',content:'/static/assets/images/kbsa_thumb.gif'},
					{title:'吃惊',content:'/static/assets/images/cj_thumb.gif'},
					{title:'害羞',content:'/static/assets/images/shamea_thumb.gif'},
					{title:'挤眼',content:'/static/assets/images/zy_thumb.gif'},
					{title:'闭嘴',content:'/static/assets/images/bz_thumb.gif'},
					{title:'鄙视',content:'/static/assets/images/bs2_thumb.gif'},
					{title:'爱你',content:'/static/assets/images/lovea_thumb.gif'},
					{title:'泪',content:'/static/assets/images/sada_thumb.gif'},
					{title:'偷笑',content:'/static/assets/images/heia_thumb.gif'},
					{title:'亲亲',content:'/static/assets/images/qq_thumb.gif'},
					{title:'生病',content:'/static/assets/images/sb_thumb.gif'},
					{title:'太开心',content:'/static/assets/images/mb_thumb.gif'},
					{title:'懒得理你',content:'/static/assets/images/ldln_thumb.gif'},
					{title:'右哼哼',content:'/static/assets/images/yhh_thumb.gif'},
					{title:'左哼哼',content:'/static/assets/images/zhh_thumb.gif'},
					{title:'嘘',content:'/static/assets/images/x_thumb.gif'},
					{title:'衰',content:'/static/assets/images/cry.gif'},
					{title:'委屈',content:'/static/assets/images/wq_thumb.gif'},
					{title:'吐',content:'/static/assets/images/t_thumb.gif'},
					{title:'打哈欠',content:'/static/assets/images/k_thumb.gif'},
					{title:'抱抱',content:'/static/assets/images/bba_thumb.gif'},
					{title:'怒',content:'/static/assets/images/angrya_thumb.gif'},
					{title:'疑问',content:'/static/assets/images/yw_thumb.gif'},
					{title:'馋嘴',content:'/static/assets/images/cza_thumb.gif'},
					{title:'拜拜',content:'/static/assets/images/88_thumb.gif'},
					{title:'思考',content:'/static/assets/images/sk_thumb.gif'},
					{title:'汗',content:'/static/assets/images/sweata_thumb.gif'},
					{title:'困',content:'/static/assets/images/sleepya_thumb.gif'},
					{title:'睡觉',content:'/static/assets/images/sleepa_thumb.gif'},
					{title:'钱',content:'/static/assets/images/money_thumb.gif'},
					{title:'失望',content:'/static/assets/images/sw_thumb.gif'},
					{title:'酷',content:'/static/assets/images/cool_thumb.gif'},
					{title:'花心',content:'/static/assets/images/hsa_thumb.gif'},
					{title:'哼',content:'/static/assets/images/hatea_thumb.gif'},
					{title:'鼓掌',content:'/static/assets/images/gza_thumb.gif'},
					{title:'晕',content:'/static/assets/images/dizzya_thumb.gif'},
					{title:'悲伤',content:'/static/assets/images/bs_thumb.gif'},
					{title:'抓狂',content:'/static/assets/images/crazya_thumb.gif'},
					{title:'黑线',content:'/static/assets/images/h_thumb.gif'},
					{title:'阴险',content:'/static/assets/images/yx_thumb.gif'},
					{title:'怒骂',content:'/static/assets/images/nm_thumb.gif'},
					{title:'心',content:'/static/assets/images/hearta_thumb.gif'},
					{title:'伤心',content:'/static/assets/images/unheart.gif'},
					{title:'ok',content:'/static/assets/images/ok_thumb.gif'},
					{title:'耶',content:'/static/assets/images/ye_thumb.gif'},
					{title:'good',content:'/static/assets/images/good_thumb.gif'},
					{title:'不要',content:'/static/assets/images/no_thumb.gif'},
					{title:'赞',content:'/static/assets/images/z2_thumb.gif'},
					{title:'来',content:'/static/assets/images/come_thumb.gif'},
					{title:'弱',content:'/static/assets/images/sad_thumb.gif'},
					{title:'蜡烛',content:'/static/assets/images/lazu_thumb.gif'},
					{title:'蛋糕',content:'/static/assets/images/cake.gif'}
				]
			},{
				title: '文字',
				type: 'text',
